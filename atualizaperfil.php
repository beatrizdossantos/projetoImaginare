...
session_start();
if((!isset($_SESSION['codLeitor'])==true) and (!isset($_SESSION['nomeLeitor'])==true) and (!isset($_SESSION['emailLeitor'])==true)) {
  unset($_SESSION['codLeitor']);
  unset($_SESSION['nomeLeitor']);
      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" action="update_perfil.php" method="POST">

              <div class="form-label-group">
                <input name="codLeitor" type="text" value="<?php echo "{$linha['codLeitor']}"; ?>" id="last_name" class="form-control" placeholder="Insira aqui sua nova condição" required autofocus readonly="readonly">
                <label for="last_name">Código do Leitor</label>
              </div>
              ...
              <div class="form-label-group">
                ...
                <label for="last_name">Nome de Usuário</label>
              </div>
              ...
              <div class="form-label-group">
                <input name="condicao_nova" type="text" value="<?php echo "{$linha['condição']}"; ?>" id="password" class="form-control" placeholder="Insira o ano em que você nasceu" required>
                <label for="password">Condição</label>
              </div>
