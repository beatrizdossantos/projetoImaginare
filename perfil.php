        ...
        <div class="row">
          ...
          <div  data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
                  ...
                  <form class="form" action="atualizaperfil.php" method="post" id="registrationForm">
          ...
          <div  data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title"><a>Condição</a></h4>
              <h2><?php echo "{$linha['condição']}"; ?></h2>
            </div>
          </div>
...
<section id="intro" class="col-md-12 col-lg-12">
    <div class="container d-flex h-100">
        <div class="col-md-6 intro-info order-md-first order-last">
          ...
          <div>
            <a href="atualizaperfil.php?codLeitor= <?php echo " {$linha['codLeitor']}"; ?>" class="btn-get-started scrollto">Atualizar</a>

            <a href="delete_perfil.php?codLeitor= <?php echo " {$linha['codLeitor']}"; ?>" class="btn-get-started scrollto">Deletar Conta</a>
          </div>
